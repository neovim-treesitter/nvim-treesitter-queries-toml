# nvim-treesitter-queries-toml

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-toml/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-toml/actions/workflows/validate.yml)

Neovim tree-sitter queries for **toml**, part of the
...
- [ ] Changes are scoped to `toml` — do not include files for other languages
